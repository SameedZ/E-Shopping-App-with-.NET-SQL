...
namespace V_Mart
{
    public partial class DashboardComplainCenter : Form
    {
        ...
        public DashboardComplainCenter()
        {
            InitializeComponent();
        ...
        private void DashboardComplainCenter_Load(object sender, EventArgs e)
        {
            ...
            string query = "Select * from ComplainFeed ";
